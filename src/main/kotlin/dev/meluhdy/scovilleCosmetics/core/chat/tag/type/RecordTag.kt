...
class RecordTag(id: String, tag: String, val course: UUID, uuid: UUID = UUID.randomUUID()) : ChatTag(id, tag, TagType.RECORD, uuid) {
...
object RecordTagSerializer : ChatTagSerializer<RecordTag>() {
    ...
    class RecordTagBuilder : ChatTagBuilder<RecordTag>() {
        ...
        override fun build(): RecordTag = RecordTag(id, tag, course, uuid)
